      ...
      <section className="py-24 bg-brand-sand/10 border-t border-brand-beige">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Tools designed to solve spatial optimization so you <Link href="/blog/avoid-overweight-baggage-fees" className="text-brand-orange underline font-medium">never pay overweight baggage fees</Link> again.</p>
          </div>
